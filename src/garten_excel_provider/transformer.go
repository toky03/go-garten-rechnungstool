...
func (v VariableData) ToCalculatedTableData(debtor PaechterData) CalculatedData {
...
func (debtor PaechterData) ToReceiverAdress() document.ReceiverAdress {
	var heading string
...
func tranlate(language string, text document.TranslatedText) string {
	if language == "fr" {
		return text.Fr
	}
	return text.De
