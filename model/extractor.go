...
func ReadDebtorData(workbook *excelize.File) []DebtorData {

	var debtors []DebtorData = make([]DebtorData, 0)
...
func extractTranslation(workbook *excelize.File, columnIndex int) (TranslatedText, error) {
